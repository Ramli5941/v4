...
echo -e "${BIBlue} └──────────────────────────────────────────────────────┘"
echo -e "${BIBlue} ┌─────────────────────────────────────────────────────┐"
echo -e "${BIBlue} │ \033[0m ${BOLD}${BIPurple}XXX${BIYellow} SSH${BIPurple}  XXX  ${BIYellow}VMESS  ${BIPurple}XXX  ${BIYellow}VLESS  ${BIPurple}XXX  ${BIYellow}TROJAN${BIPurple} XXX ${NC} "
...
echo -e "${BIBlue} │ User       ${NC}   : ${BIWhite} $Name"
echo -e "${BIBlue} │ Expiry script${NC} : ${BIYellow} $useexp"
echo -e "${BIBlue} └─────────────────────────────────────┘"
echo
