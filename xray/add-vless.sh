...
vlesslink4="vless://${uuid}@api.useinsider.com:80?path=vless-grpc&encryption=none&host=${sts}${domain}&type=ws#DIGI-APN-${user}"
vlesslink5="vless://${uuid}@162.159.134.61:80?path=vless-grpc&encryption=none&host=${sts}${domain}&type=ws#DIGI-BOSSTER-${user}"
vlesslink6="vless://${uuid}@${domain}:80?path=vless-grpc&encryption=none&host=m.pubgmobile.com&type=ws#UMOBILE-FUNZ-${user}"
vlesslink7="vless://${uuid}@104.17.113.188:80?path=vless-grpc&encryption=none&host=eurohealthobservatory.who.int.${domain}&type=ws#YES-${user}"
vlesslink8="vless://${uuid}@104.17.148.22:80?path=vless-grpc&encryption=none&host=www.speedtest.net.${domain}&type=ws#SELCOM-0BASIC-${user}"
vlesslink9="vless://${uuid}@104.17.10.12:80?path=vless-grpc&encryption=none&host=cdn.who.int.${domain}&type=ws#UNIFI-Bebas-${user}"
vlesslink10="vless://${uuid}@speedtest.unifi.com.my.${domain}:80?path=vless-grpc&encryption=none&host=&type=ws#Uni5G-${user}"
